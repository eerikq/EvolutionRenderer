...
void bufferCreateVertex(const VkPhysicalDevice physical_device, const VkDevice logical_device) {
...
void bufferCreateIndex(const VkPhysicalDevice physical_device, const VkDevice logical_device) {
